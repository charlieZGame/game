...
public abstract interface PlayUserRepository extends JpaRepository<PlayUser, String> {
	...
	public abstract PlayUser findByUsername(Integer username);
	...
	public abstract Page<PlayUser> findByDatastatusAndUsername(boolean datastatus,String username, Pageable paramPageable);

	public abstract Page<PlayUser> findByUsercategory(String usercategory,Pageable paramPageable);
