...
public class UKWebAppConfigurer 
    ...
    public void addInterceptors(InterceptorRegistry registry) {
    	...
    	registry.addInterceptor(new UserInterceptorHandler()).addPathPatterns("/**").excludePathPatterns("/login.html").excludePathPatterns("/tokens").excludePathPatterns("/api/**").excludePathPatterns("/login/**");
